...
def send_to_token(msg):
    ...
    print('Response code from Firebase: :', response.getResponses())
    # [END send_to_token]
...
def scrapeMumum(request):
    ...
    if request.method=="POST":
        ...
        if 'img' in request.FILES:
            ...
            destination.close()
            initSize = (os.stat("/home/www/static/alarmpics/filename.jpg").st_size)//1000
            foo = Image.open("/home/www/static/alarmpics/filename.jpg")
            print(resImg)
            print(foo.size)
